...
INSERT INTO `personalInformation` (`IDpersonal`, `fname`, `lname`, `dayBirth`, `monthBirth`, `yearBirth`, `email`, `phone`, `streetAddress`,
    ...
    VALUES (NULL, 'Christopher', 'Zeik', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);INSERT INTO personalInformation (IDpersonal, fname, lname, dayBirth, monthBirth, yearBirth, email, phone, streetAddress, city, stateAddress, zip, country) VALUES 
...
INSERT INTO `personalInformation` (`IDpersonal`, `fname`, `lname`, `dayBirth`, `monthBirth`, `yearBirth`, `email`, `phone`, `streetAddress`, `city`, `stateAddress`, `zip`, `country`) VALUES (NULL, 'John', 'Berkley', '03', '23', '1995', 'berkley_yeet@yahoo.com', '985-406-7859', '4592 Bassel Street', 'Houma, Louisiana', 'LA', '70360', 'America');
INSERT INTO personalInformation(IDpersonal, fname, lname, dayBirth, monthBirth, yearBirth, email, phone, streetAddress, city, stateAddress, zip, country)
